...
std::vector<DragonData::AnimData> DragonData::ANIM_DATA =
{
	...
	{ "Character\\Dragon\\anim\\scream.x",			false,	101.0f,		0.1f },	// 咆哮
	{ "Character\\Dragon\\anim\\takeOff.x",			false,	121.0f,		0.0f },	// 離陸
	{ "Character\\Dragon\\anim\\attackflame.x",		false,	81.0f,		0.2f },	// ブレス攻撃
	{ "Character\\Dragon\\anim\\attackHand.x",		false,	91.0f,		0.5f },	// 飛び掛かり攻撃
	{ "Character\\Dragon\\anim\\attackMouth.x",		false,	36.0f,		0.3f },	// 噛みつき攻撃
