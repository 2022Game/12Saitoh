...
void CEnemy::Update()
{
	...
	else if (CInput::PushKey('0')) ChangeAnimation(EAnimType::eFear_Right);
	if (CInput::Key('T') && CInput::PushKey('1')) ChangeAnimation(EAnimType::eFear_Left);
	else if (CInput::Key('T') && CInput::PushKey('2')) ChangeAnimation(EAnimType::eDeath);
	else if (CInput::Key('T') && CInput::PushKey('3')) ChangeAnimation(EAnimType::eFly);
	else if (CInput::Key('T') && CInput::PushKey('4')) ChangeAnimation(EAnimType::eFly_Attack);
	else if (CInput::Key('T') && CInput::PushKey('5')) ChangeAnimation(EAnimType::eFly_Breath);
	else if (CInput::Key('T') && CInput::PushKey('6')) ChangeAnimation(EAnimType::eFly_Fear);
	else if (CInput::Key('T') && CInput::PushKey('7')) ChangeAnimation(EAnimType::eFly_Death);
#endif
}
